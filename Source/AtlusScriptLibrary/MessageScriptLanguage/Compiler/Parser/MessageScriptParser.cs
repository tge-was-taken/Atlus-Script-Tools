...
public partial class MessageScriptParser : Parser {
	...
	public partial class DialogContext : ParserRuleContext {
		...
		public ITerminalNode[] EmptyLine() { return GetTokens(MessageScriptParser.EmptyLine); }
		public ITerminalNode EmptyLine(int i) {
			return GetToken(MessageScriptParser.EmptyLine, i);
		}
